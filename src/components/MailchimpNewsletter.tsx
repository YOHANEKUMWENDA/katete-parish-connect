      ...
      <div className="mx-auto max-w-3xl px-4 lg:px-8 text-center">
        ...
        <div id="mc_embed_shell" className="max-w-md mx-auto">
          <div id="mc_embed_signup">
            <form
              action="https://YOUR_MAILCHIMP_DOMAIN/subscribe/post?u=YOUR_LIST_ID&id=YOUR_FORM_ID"
              method="post"
            ...
            >
              ...
              <div aria-hidden="true" style={{ position: "absolute", left: "-5000px" }}>
                <input type="text" name="b_YOUR_LIST_ID_YOUR_FORM_ID" tabIndex={-1} value="" readOnly />
              </div>
