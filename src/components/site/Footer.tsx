      ...
      <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="text-sm leading-relaxed">
            A faithful community of the Mzuzu Diocese, serving Christ and our neighbors in Champira, Mzimba District.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex gap-2"><MapPin className="h-4 w-4 mt-0.5 text-[var(--gold)]" /> Champira, Mzimba District, Northern Region, Malawi</li>
            <li className="flex gap-2"><Phone className="h-4 w-4 mt-0.5 text-[var(--gold)]" /> +265 98 451 8884</li>
            <li className="flex gap-2"><Mail className="h-4 w-4 mt-0.5 text-[var(--gold)]" /> info@sttheresacatholic.org</li>
          </ul>
