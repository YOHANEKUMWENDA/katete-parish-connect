      ...
      <section className="section-pad bg-white">
        <div className="mx-auto max-w-4xl px-4 lg:px-8 prose-lg">
          ...
          <p className="mt-5 text-[var(--muted-foreground)] leading-relaxed">
            ...
            parish grew into a vibrant community — building schools, chapels, and a community rooted in
            Christ and the Eucharist.
          </p>
          <p className="mt-4 text-[var(--muted-foreground)] leading-relaxed">
            Today, as part of the Mzuzu Diocese, St. Thereza serves thousands of faithful across Champira and
