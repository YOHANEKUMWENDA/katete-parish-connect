...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "St. Thereza Catholic Church — Mzuzu Diocese, Malawi" },
      { name: "description", content: "Welcome to St. Thereza Catholic Church in Champira, Mzimba District. Join us for Mass, sacraments, ministries and community life." },
      { property: "og:title", content: "St. Thereza Catholic Church" },
      { property: "og:description", content: "A welcoming parish of the Mzuzu Diocese in Champira, Mzimba District." },
  ...
  return (
    <SiteLayout>
      ...
      <section className="relative min-h-[88vh] flex items-center justify-center text-center text-[var(--cream)] overflow-hidden">
        <img src={heroImg} alt="St. Thereza Catholic Church at sunset" className="absolute inset-0 w-full h-full object-cover" width={1920} height={1280} />
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-24 animate-fade-up">
          ...
          <h1 className="font-serif text-4xl sm:text-6xl md:text-7xl leading-tight">
            Welcome to St. Thereza<br/>Catholic Church
          </h1>
          <p className="mt-6 text-base md:text-lg text-[var(--cream)]/85 max-w-2xl mx-auto">
            A faith-filled community in Champira, Mzimba District — gathered to worship Christ,
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-8 grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="animate-fade-up">
            ...
            <p className="mt-5 text-[var(--muted-foreground)] leading-relaxed">
              Rooted in the Catholic faith and the rich tradition of the Mzuzu Diocese, St. Thereza Catholic Church
              has been a place of prayer, learning, and service for generations. We welcome every soul
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-8 text-center">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              { q: "The Outreach Ministry restored hope to so many families in Champira.", n: "Sr. Mary Chirwa", r: "Pastoral Team" },
            ].map(({ q, n, r }) => (
